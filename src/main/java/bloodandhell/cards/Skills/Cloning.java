...
import bloodandhell.powers.CloningAction;
...
public class Cloning extends BaseCard {
    public static final String ID = makeID(Cloning.class.getSimpleName());
    ...
    public Cloning(String ID, CardStats info) {
        super(ID, info);
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {  //Dans use, p = player et m = targeted ennemy. m =null si aucun ennemi n'est pointé)
        addToBot((AbstractGameAction) new CloningAction(this.magicNumber));
    }
