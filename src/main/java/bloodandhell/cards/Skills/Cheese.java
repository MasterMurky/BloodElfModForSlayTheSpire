...
public class Cheese extends BaseCard {
    public static final String ID = makeID(Cheese.class.getSimpleName());
    ...
    private static final int UPG_MN = 3; //c'est la quantité de block obtenu lors de l'upgrade
    ...
    public Cheese(String ID, CardStats info) {
        super(ID, info);
    }
