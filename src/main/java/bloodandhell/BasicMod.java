...
import bloodandhell.potions.BasePotion;
import bloodandhell.relics.BaseRelic;
import bloodandhell.util.GeneralUtils;
import bloodandhell.util.KeywordInfo;
...
public class BasicMod implements
        EditRelicsSubscriber, // keep at the top of the list !
        EditCardsSubscriber, // also keep at the top of the list
    ...
    private static final String resourcesFolder = "bloodandhell";
    ...
    //COULEUR: ici j'ai mis 0/0/0 donc ça fait du nouar pur
    private static final Color cardColorBLAKK = new Color(1.0f, 25f/255f, 0f/255f, 1f);
    ...
    public static void initialize() {
        ...
        BaseMod.addColor(MyCharacter.Enums.CARD_COLOR,cardColorBLAKK, BG_ATTACK, BG_SKILL, BG_POWER, ENERGY_ORB,
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new MyCharacter(),
                CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT, MyCharacter.Enums.TORMENTED_ONE);
    }
